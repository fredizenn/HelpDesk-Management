...
<Modal
	title="Ticket Details: {currentTicket?.code}"
	bind:open={showDetailForm}
	showIcon={false}
		...
		<div class="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5">
			<dl class="flex flex-wrap">
				<div class="flex-auto pl-6 pt-6">
					...
					<dd class="text-base font-semibold leading-6 text-gray-900">
				...
				<div class="mt-4 flex w-full flex-none gap-x-4 px-6">
					...
					<dd class="text-sm leading-6 text-gray-500">{currentTicket?.contactEmail || 'none'}</dd>
				</div>
				<div class="mt-6 border-t border-gray-900/5 px-6 py-6">
					<a
						href="mailto:?subject=Response%20From%20WIUC%20Customer%20Service&to={currentTicket?.contactEmail}&body=Hello%20{currentTicket?.contactName},%0D%0A%0D%0AThis%20is%20the%20response%20to%20your%20request%20at%20the%20WIUC%20HelpDesk%20with%20ticket%20number%20{currentTicket?.code}."
						target="_blank"> Send customer tracking via email <span aria-hidden="true">&rarr;</span></a
					>
				</div>
